<template>
  <main>
    <div>
      <h1 class="font-medium leading-tight text-5xl mt-0 mb-2 text-blue-500">Mamasafi Services</h1>
    </div>
    <button type="button"
      ...
      <template #form>
       <form>
          ...
          <div class="flex justify-center">
            <div class="mb-3 w-96">
              <label for="formFile" class="form-label inline-block mb-2 text-gray-700">Upload Display Image</label>
    ...
    <DataTable :tableCols="tableCols" :tableData="services" :routeTo="'service'"/>
  </main>
</template>
...
const tableCols =['#', 'Image', 'Service Name', 'Status']
const services = [
  { id:1, image:'/imgs/Mamasafi Logo.webp', name: "Laundry & House Cleaning", status: "1" },
  { id:2, image:'/imgs/Mamasafi Logo.webp', name: "Duvet Cleaning", status: "0" },
  { id:3, image:'/imgs/Mamasafi Logo.webp', name: "House Cleaning", status: "1" },
  { id:4,  image:'/imgs/Mamasafi Logo.webp', name: "machina", status: "0" },
];
</script>