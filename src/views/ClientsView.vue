<template>
  <main>
    <div>
      <h1 class="font-medium leading-tight text-5xl mt-0 mb-2 text-blue-500">Mamasafi Clients</h1>
    </div>
    <button type="button"
    @click="toggleModal('AddClientModal')" 
    ...
    <!-- add service modal -->
    <ModalVue :isOpen="'AddClientModal'">
      <template #modalTitle>Add Client Form</template>
      <template #form>
       <form>
    ...
    <!-- end add service -->
    <!-- Edit service modal -->
    <ModalVue :isOpen="'EditClientModal'">
    ...
    <!-- Delete data Modal -->
    <ModalVue :isOpen="'DeleteClientModal'">
      <template #modalTitle>
    ...
    <DataTable :tableCols="tableCols" :tableData="services" :routeTo="'Client'"/>
  </main>
</template>
...
const tableCols =['Emp. ID', 'Image', 'Name','Email','Phone', 'Status']
const services = [
  { id:1, image:'https://lavinephotography.com.au/wp-content/uploads/2017/01/PROFILE-Photography-112.jpg', name: "Caroline Wanjiku", email: "machina@gmail.com", phone: "0735694526", status: "1" },
  { id:2, image:'/imgs/Mamasafi Logo.webp', name: "Evelyne Wairimu", email: "machina@gmail.com", phone: "0735694526", status: "0" },
  { id:3, image:'/imgs/Mamasafi Logo.webp', name: "Joyce Wekesa", email: "machina@gmail.com", phone: "0735694526", status: "1" },
  { id:4,  image:'/imgs/Mamasafi Logo.webp', name: "Lydia Akinyi", email: "machina@gmail.com", phone: "0735694526", status: "0" },
];
</script>